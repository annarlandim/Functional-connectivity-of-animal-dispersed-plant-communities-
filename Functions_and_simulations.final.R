...
# (uses preference web and species abundances)
...
### Estimate species abundances:

# We used fruit size and avian body mass to estimate species abundances.
...
# Interaction networks built using species abundances and interaction probabilites:
...
# since species abundances have decimals, the total number of interaction events is a bit below the sum of species abundances
...
# Calculate total plant abundance in the target patch communities
...
# Applying a threshold for the number of seeds that reach the target patch.
...
# Estimate plant diversity in the target patch 
